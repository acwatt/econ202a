...
# ╔═╡ 1fe7f358-e2e9-4416-9b2e-6e8504558602
"""
	f(x)
...
# ╔═╡ 1f42aac9-5094-44ef-b1f3-9b750506617f
f(x,y) = log(x+y);

# ╔═╡ 02962fec-0d1b-418e-a833-be8684c53240
md"## (a) The `PolyBasis` function"

# ╔═╡ 41e85607-ba67-4ea8-9c2d-d0199cf78424
"""
PolyBasis(K,Z)
...
# ╔═╡ b70ce6d8-f096-4bfd-9912-5e18ff669bef
md"## (b) The `PolyGetCoeff` function"

# ╔═╡ 6bde315c-95ae-482d-b86f-d0272ce0d0bd
md"""## (c)-(e) Get Polynomial Approximation Coefficients
...
# ╔═╡ 59901d64-faad-44f4-82b1-b3b6050a586c
md"""## (f)-(g) Calculate the true and approximated function values on a larger grid

- repeating for n=15 and 35 to use in part (k)
- also calcuating the error norm to use in part (i)
"""

# ╔═╡ 5cdf8fbf-01af-4185-a20c-4533e011d936
md"## (h) Plot the true and approximated surfaces"

# ╔═╡ 3585d9ac-2815-4fc6-acff-55c51cc98cd6
md"## (i) Maximum absolute value of the difference"

# ╔═╡ 3e7df529-4053-4908-b12b-9a38f2ccad7d
md"## (j) Plot the difference between the true and approximated surfaces"

# ╔═╡ e45d3a80-833e-4330-a46a-2db33052b4d3
md"""## (k) Repeat for `n`=15 and 35
...
# ╔═╡ 2a886782-01e1-4047-b2c5-fa82dcd6df90
md"""## (l) Discuss the quality of polynomial approximations
...
# ╔═╡ 5e68ba0b-4988-4495-9c89-4165afe1d057
md"""### Functions for the univarite problem
...
# ╔═╡ 8ced4091-d3e6-47c1-8651-e905e08eb420


# ╔═╡ c9776690-88d4-455e-95c1-72b572457a5b
function PolyBasis(X)
    B = [ones(size(X)) X X.^2]
    return B
end;

# ╔═╡ 3d7f49f4-7e90-420b-845c-e8545566ccca
"""
	PolyGetCoef(X,Y,Z)
...
# ╔═╡ b54f5ffc-c8c5-4604-82a7-9afa3087f893
...
# ╔═╡ b714695a-260b-400f-bcee-8a693e4272bf
"""
	gen_2d_coef(n)
...
# ╔═╡ c54ec209-4dc0-4719-a59f-8958af5b5103
"""
	gen_1d_coef(n)
...
# ╔═╡ c52c5714-da65-44c1-ac07-c9a9249a957b
md"### Plotting for the `n`=5 case"

# ╔═╡ 84c88e1a-93b8-4f22-825a-3aaab7e9b4ee
md"### Plotting for all `n` cases"

# ╔═╡ 493aea66-1b4e-4880-8821-528e66997d5c
md"""### Plotting Errors for all `n` cases

The vertical line at x=4.0 represents the interpolation vs extrapolation erorrs -- extrapolation occurs to the right of the vertical line.
"""
...
Markdown.parse("""
Max Interpolation Error = $(round(data_2d[5]["norm in"], digits=DIGITS)) (over the range 0.1-2.0)

Max Extrapolation Error = $(round(data_2d[5]["norm out"], digits=DIGITS)) (over the range 0.1-2.5)
""")
...
# ╔═╡ 9b874a75-dceb-4569-8170-f607ec3e7525
"""
...
# ╔═╡ 4ab0c950-777c-4ff1-a623-9dcdeed6a1d7
begin
...
# ╔═╡ 7764e660-1bd6-428e-bce8-5788da894fa7
begin
...
# ╔═╡ 1815cac3-2745-41f9-b1ba-097b96688de0
"""
...
# ╔═╡ a3520ec9-5529-4fee-9c42-46f127e5e208
# ╠═╡ show_logs = false
begin
	...
	surface!(x, y, ε,
		title="Approximation Erorr for f(x,y) [n=$n]",
		camera=(50,25),alpha = 0.5)
end

# ╔═╡ d97edf99-ea59-4cde-a37a-31589cc731d4
"""
	plot_surface(n)
...
# ╔═╡ 264eaf25-d666-4ca0-9b95-bbae935a1701
md"# Appendix - Unused code, saved for later"
...
# ╔═╡ 6f8370bc-3061-46dd-a1ad-5f73756c307a
begin
